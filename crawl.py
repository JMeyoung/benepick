...
SOURCE_URL = "https://www.tworld.co.kr/web/benefits/benefits-list"
OUTPUT_DIR = Path("skt_screenshots")
OUTPUT_JSON = Path("skt_benefits.json")
VIEWPORT = {"width": 1280, "height": 800}
TODAY = datetime.now().strftime("%Y-%m-%dT%H:%M:%SZ")
TODAY_DATE = datetime.now()

VISION_PROMPT = f"""이 스크린샷은 SKT T world 혜택 페이지입니다.
